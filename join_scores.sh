...
# Sort them
awk -F'\t' '{print $1";"$2";"$3";"$4";"$5";"$6";"$7"\t"$8}' $file1 | awk 'NR<3{print $0;next}{print $0| "sort -k1,1"}' > file1.tsv
awk -F'\t' '{print $1";"$2";"$3";"$4";"$5";"$6";"$7"\t"$8}' $file2 | awk 'NR<3{print $0;next}{print $0| "sort -k1,1"}' > file2.tsv
...
join -a 1 -a 2 -j1 -e "null" -t $'\t' -o 0,1.2,2.2 file1.tsv file2.tsv \
	...
	| awk 'NR<3{print $0;next}{print $0| "sort -k 2.1,2 -k3,3 -n"}' > ExtraAnno1.tsv
